...
data <- read.csv("/Users/amyeldalecero/CEE_609_project/Data_download_and_preprocess_code/data/OysterNH_data.csv", header = T)
...
OysterNH_pred <- data.frame(water_year = OysterNH_train$water_year,
                            obs_wbet = OysterNH_train$WB_annual_total_aet,
                            pred_wbet = pred_OysterNH_aet,
                            residuals = residuals(OysterNH_m4))

write.csv(OysterNH_pred, "/Users/amyeldalecero/CEE_609_project/Model_train_and_validate_code/data/OysterNH_pred.csv",
          row.names = FALSE)
